...
class SaveLoyaltyCardToOrderObserver implements ObserverInterface {
        ...
        if($this->_state->getAreaCode() != \Magento\Framework\App\Area::AREA_ADMINHTML){
            foreach ($inputParams as $inputParam) {
                if ($inputParam instanceof \Magento\Quote\Model\Quote\Payment) {
                    ...
                    if(isset($paymentData['loyalty_card'])){
                        $paymentQuote->setData('loyalty_card', $paymentData['loyalty_card']);
                        $paymentOrder->setData('loyalty_card', $paymentData['loyalty_card']);
                    }
                }
            }
        }
